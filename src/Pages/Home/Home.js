...
const Home = () => {
    ...
    return (
        <div>
           <Banner></Banner>
           <h1 className='text-5xl text-center text-bold mt-5 mb-5'>Products</h1>
       ...
       {/* comment */}
            <h1 className='text-5xl text-center text-bold my-5 '>Reviews</h1>
          <div className='grid sm:grid-cols-1 lg:grid-cols-3 gap-2 justify-items-center m-5 py-5'>
                {
